...
/**
 * ResourceStatsReviews Class Doc Comment
 *
 * @package  Aternos\SpigotApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 ...
 */
class ResourceStatsReviews implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Resource_stats_reviews';
    ...
    */
     ...
     * Sets unique
     *
     * @param int|null $unique unique
     *
     * @return $this
     */
    public function setUnique(?int $unique): static
    {
        if (is_null($unique)) {
