...
class Author implements ModelInterface, ArrayAccess, JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Author';
    ...
    protected static array $openAPITypes = [
        ...
        'username' => 'string',
        'resource_count' => 'int',
        'identities' => '\Aternos\SpigotApi\Model\AuthorIdentities',
        'avatar' => 'string',
        'last_activity' => 'int'
    ];
    ...
    */
     ...
     * Sets resource_count
     *
     * @param int|null $resource_count resource_count
     *
     * @return $this
     */
    public function setResourceCount(?int $resource_count): static
    {
     ...
     * Gets identities
     *
     * @return \Aternos\SpigotApi\Model\AuthorIdentities|null
     */
    public function getIdentities(): ?\Aternos\SpigotApi\Model\AuthorIdentities
    {
     ...
     * Sets identities
     *
     * @param \Aternos\SpigotApi\Model\AuthorIdentities|null $identities identities
     *
     * @return $this
     */
    public function setIdentities(?\Aternos\SpigotApi\Model\AuthorIdentities $identities): static
    {
     ...
     * Sets last_activity
     *
     * @param int|null $last_activity Last activity timestamp (in seconds)
     *
     * @return $this
     */
